        ...
        <div class="col-md-3 d-flex flex-column p-0 sidebar">
          <div class="sidebar-content flex-grow-1 d-flex flex-column justify-content-between">
            ...
            <div class="text-center py-4">
              ...
              <h2 class="titulo-sidebar">Equipos</h2>
            </div>
            <!-- Opciones -->
            <div class="enlaces-centrales">
              <ul class="list-unstyled">
                ...
                <li class="opcion-link">
                  <router-link :to="{name:'insertarE'}" class="enlace-menu">
                    <span>Nueva Equipo</span>
                  </router-link>
                </li>
                <li class="opcion-link">
                  <a href="#" @click.prevent="consultarEquipos" class="enlace-menu">
...
export default {
  ...
  computed: {
    equiposFiltrados() {
        ...
        if (!this.filtroActivo) return this.equipos
        return this.equipos.filter(u =>
            u.numeroActivo.toLowerCase().includes(this.filtroActivo.toLowerCase())
        )
    }
  },
  methods: {
